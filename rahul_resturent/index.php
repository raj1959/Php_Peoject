...
<body>
	...
	<!--Header_section-->
	<header id="header_outer" style="background-color: #BD65F0">
		<div class="container">
			<div class="header_section">
				...
				<nav class="nav" id="nav">
					...
					<ul class="" >
						...
						<li><a href="#contact" >Contact</a></li>
						<div class="btn-group">
						  <button type="button" class="btn btn-default btn-lg" style="width: 100px; font-size: 20px; font-weight: bolder;">Login</button>
						  <button type="button" class="btn btn-primary btn-lg dropdown-toggle" data-toggle="dropdown" >
						    <span class="caret"></span>
						  </button>
						  <ul class="dropdown-menu" role="menu">
						    <li><a href="login.php" id="l">User Login</a></li>
						    <li><a href="Admin/" id="l">Admin Login</a></li>
						  </ul>
						</div>
					</ul>
				</nav>
		...
		<div class="container">
			<div class="footer_bottom">
				...
				<div class="credits">
					...
					<a href="#">Free Templates</a> by Rahul Raj
				</div>
			</div>
		</div>
	</footer>
