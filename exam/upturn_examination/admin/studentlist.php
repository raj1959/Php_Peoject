...
<a href = "action.php" > Inactivate </a></button>
<?php
}
if(($status)=='1')
{
...
<a href = "re-activate.php" "> Activate</a></button><?php
}
?>

	<button class="btn btn-dark text-white "><a href = "deletestudent.php" ">Delete </a> </button>
 
	<button class="btn bg-alert dark text-white "><a href ="editstudent.php?id=<?php echo htmlentities($result->id);?>"> Edit </a></button>
	</td>
    </tr>
<?php }?>
</tbody>
