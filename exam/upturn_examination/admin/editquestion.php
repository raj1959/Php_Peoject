...
if($_SESSION["userid"]==true)
{
	   ...
	   if(isset($_GET['id']))
       {
	     ...
	     if(isset($_POST['update']))
         {
		   ...
		   $updated=mysql_query("UPDATE questiontbl SET questionname='$question',op1='$op1',op2='$op2',op3='$op3',op4='$op4',correctop='$correct_op' WHERE qid='$qid'") or die();
       if($updated)
      {
...
<?php 
  ...
  $getselect=mysql_query("SELECT * from questiontbl  WHERE qid='$id'");
 
  while($q = mysql_fetch_array($getselect))
  {  
