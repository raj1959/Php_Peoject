...
if($_SESSION["userid"]==true)
{
	   ...
	   if(isset($_GET['id']))
       {
	     ...
	     if(isset($_POST['update']))
         {
		   ...
		   $name=$_POST['catnm'];	
		   $updated=mysql_query("UPDATE subjecttbl SET subname='$subname',deptname='$deptname', catname='$name' WHERE sid='$id'") or die();
       if($updated)
      {
...
<?php 
  ...
  $getselect=mysql_query("SELECT * from subjecttbl  WHERE sid='$id'");
 
  while($subject = mysql_fetch_array($getselect))
  {  
